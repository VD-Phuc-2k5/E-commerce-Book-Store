      ...
      <div className='footer-container'>
        <div className='footer-grid'>
          <div className='footer-section'>
            ...
            <p>
              An independent bookstore committed to literature, community, and
              the joy of reading since 1995.
            </p>
            <address>
              <p>123 Reading Lane</p>
              <p>Bookville, BK 98765</p>
              <p style={{ marginTop: "8px" }}>
                <a href='tel:+15551234567'>(555) 123-4567</a>
              </p>
              <p>
                <a href='mailto:abc@bookstore.com'>abc@bookstore.com</a>
              </p>
            </address>
          </div>
          ...
          <div className='footer-section'>
            ...
            <ul className='footer-links'>
              ...
              <li>
                <NavLink to='#'>Non-Fiction</NavLink>
              </li>
              <li>
                <NavLink to='#'>Children's Books</NavLink>
              </li>
              <li>
                <NavLink to='#'>Book Club</NavLink>
              </li>
            </ul>
          </div>
        ...
        <div className='copyright'>
          ...
          <p>
            Designed with <span className='heart'>♥</span> for book lovers
            everywhere.
          </p>
        </div>
      </div>
